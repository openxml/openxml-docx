module OpenXml
  module Vml
    module Elements
      class Shape < OpenXml::Docx::Elements::Container
        namespace :v
        tag :shape

        attribute :adjustments, expects: :string, displays_as: :adj
        ...
        with_namespace :o do
          ...
          attribute :bw_mode, displays_as: :bwmode, one_of:  %i(auto black blackTextAndLines color
                                                              grayOutline grayScale hide highContrast
                                                              inverseGray lightGrayscale undrawn white)
          attribute :bw_normal, displays_as: :bwnormal, one_of: %i(auto black blackTextAndLines color
                                                                grayOutline grayScale hide highContrast
                                                                inverseGray lightGrayscale undrawn white)
          attribute :bw_pure, displays_as: :bwpure, one_of: %i(auto black blackTextAndLines color
                                                            grayOutline grayScale hide highContrast
                                                            inverseGray lightGrayscale undrawn white)
