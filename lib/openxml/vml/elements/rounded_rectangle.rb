    ...
    module Elements
      class RoundedRectangle < OpenXml::Docx::Elements::Container
        ...
        with_namespace :o do
          ...
          attribute :connector_type, displays_as: :connectortype, one_of: %i(curved elbow none straight)
          ...
          attribute :hr_align, displays_as: :hralign, one_of: %i(center left right)
          ...
          attribute :inset_mode, displays_as: :insetmode, one_of: %i(auto custom)
